...
export const StickyCtaButton = () => {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 z-50 transition-all duration-500 ease-in-out will-change-transform ${
      ...
      <div className="bg-gradient-to-t from-background via-background/95 to-transparent backdrop-blur-sm border-t border-gold/20 shadow-2xl">
        <div className="max-w-7xl mx-auto px-4 py-3 md:py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3">
              <div className="text-center sm:text-left">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-2xl md:text-3xl font-bold text-gold animate-pulse">R$ 39,99</span>
                </div>
              </div>
            </div>
            ...
            <Button
              size="lg"
              className="bg-gold hover:bg-gold-light text-background font-bold shadow-gold hover:shadow-glow transition-all duration-300 hover:scale-105 px-6 md:px-8 py-5 md:py-6 text-base md:text-lg w-full sm:w-auto will-change-transform"
              onClick={handleClick}
            >
