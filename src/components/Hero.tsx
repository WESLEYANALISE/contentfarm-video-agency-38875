    ...
    contain: 'layout'
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="text-center mb-8">
          ...
          lineHeight: '1.15'
            ...
            <span className="cinematic-gradient-text cinematic-text-shadow">
              We help B2B SaaS founders double their customers and organically acquire new users in 90 days with our done-for-you video content system
            </span>
          </h1>
        </div>
        ...
        <div className="text-center mb-6">
          ...
          lineHeight: '1.45'
        }}>Done-for-you demos, explainers, and onboarding videos</p>
        </div>
